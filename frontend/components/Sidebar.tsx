    ...
    return (
        <>
            <button
                ...
                className="fixed left-4 top-4 z-40 flex h-10 w-10 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-700 shadow-sm md:hidden"
            >
                <Menu size={22} />
            </button>
