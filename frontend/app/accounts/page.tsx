...
export default function AccountsPage() {
    ...
    async function handleSaveAccount() {
        if (!name.trim() || !startingBalance || !currency.trim()) {
        ...
        const method = editingAccountId === null ? "POST" : "PATCH";
        ...
        <div className="flex min-h-screen bg-zinc-100">
            ...
            <main className="min-w-0 flex-1 px-5 py-5 sm:px-6 md:px-8 md:py-8 xl:px-10">
                ...
                <div className="mt-8 rounded-xl border border-zinc-200 bg-white">
                    ...
                    {accountsLoading ? (
                        <p className="p-6 text-zinc-500">Loading accounts...</p>
                    ) : accounts.length === 0 ? (
                        <p className="p-6 text-zinc-500">No accounts yet.</p>
                    ) : (
                        <>
                            {/* MOBILE */}
